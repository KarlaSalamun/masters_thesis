...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{images/Uunifast.pdf}
...
Table \ref{function} contains a list of the function nodes.
\begin{table}[H]
\centering
\label{tbl:functions}
\begin{tabular}{|
...
\begin{flushleft}
  \centering
  \includegraphics[width=\linewidth, left]{images/full.pdf}
...
\begin{flushright}
  \centering
  \includegraphics[width=\linewidth, right]{images/grow.pdf}
...
Members of the \texttt{Simulator} class used for storing the active tasks are shown in Listing \ref{Simulator_class}.
...
Fig. \ref{fronts} shows the results of testing the NSGA-II algorithm.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{images/fronts.pdf}
...
\begin{flushleft}
  \centering
  \includegraphics[width=\linewidth, left]{images/single.pdf}
...
\begin{flushright}
  \centering
  \includegraphics[width=\linewidth, right]{images/multi.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{images/coev_single_sep_qos.pdf}
